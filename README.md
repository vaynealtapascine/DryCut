...
- **Fully offline:** every part of the app runs on your PC. The only network request BackgroundCut ever makes is the optional, user-initiated download of the stronger model.
