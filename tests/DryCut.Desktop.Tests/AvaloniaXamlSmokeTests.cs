...
public sealed class AvaloniaXamlSmokeTests
{
    ...
    public void MainWindowXamlLoads()
    {
        ...
        Assert.Equal("DryCut", window.Title);
    ...
    public void SettingsWindowXamlLoads()
    {
        ...
        Assert.Equal("DryCut settings", window.Title);
    ...
    {
        var modelDirectory = Directory.CreateTempSubdirectory("DryCut-settings-binding-test");
        try
        {
