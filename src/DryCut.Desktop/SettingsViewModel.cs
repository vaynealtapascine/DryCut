...
public sealed class SettingsViewModel : ObservableObject
{
        ...
        UiSettings initialUi)
    {
        ...
        _folder = initial.DefaultFolder ?? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyPictures), "DryCut");
    ...
    {
        new Choice<ExportPolicy>(ExportPolicy.DefaultFolder, "My DryCut folder"),
    ...
    public string PolicyDescription => Policy switch
    {
        ...
        _ => "Save automatically to your DryCut folder."
    };
