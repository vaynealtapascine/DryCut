; DryCut per-user installer. Build with scripts/build-release.ps1.
#ifndef AppVersion
...
AppVerName=DryCut {#AppVersion}
AppPublisher=DryCut
DefaultDirName={localappdata}\Programs\DryCut
DisableProgramGroupPage=yes
PrivilegesRequired=lowest
ArchitecturesInstallIn64BitMode=x64compatible
ArchitecturesAllowed=x64compatible
OutputDir={#OutputDir}
OutputBaseFilename=DryCut-Setup-{#AppVersion}
Compression=lzma2/ultra64
SolidCompression=yes
WizardStyle=modern
SetupIconFile=..\assets\DryCut.ico
UninstallDisplayIcon={app}\DryCut.Desktop.exe
...
[Tasks]
Name: "explorercontext"; Description: "Add 'Remove background with DryCut' to image context menu"; Flags: unchecked
...
[Icons]
Name: "{autoprograms}\DryCut"; Filename: "{app}\DryCut.Desktop.exe"
Name: "{autoprograms}\DryCut user guide"; Filename: "{app}\USER_GUIDE.txt"
Name: "{autodesktop}\DryCut"; Filename: "{app}\DryCut.Desktop.exe"; Tasks: desktopicon

[Registry]
; Always register cleanup, including entries users enable later from Settings.
Root: HKCU; Subkey: "Software\Classes\SystemFileAssociations\image\shell\DryCut"; Flags: dontcreatekey uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\SystemFileAssociations\image\shell\DryCut"; ValueType: string; ValueName: ""; ValueData: "Remove background with DryCut"; Flags: uninsdeletekey; Tasks: explorercontext
Root: HKCU; Subkey: "Software\Classes\SystemFileAssociations\image\shell\DryCut"; ValueType: string; ValueName: "Icon"; ValueData: """{app}\DryCut.Desktop.exe"""; Tasks: explorercontext
Root: HKCU; Subkey: "Software\Classes\SystemFileAssociations\image\shell\DryCut\command"; ValueType: string; ValueName: ""; ValueData: """{app}\DryCut.Desktop.exe"" ""%1"""; Flags: uninsdeletekey; Tasks: explorercontext

[UninstallDelete]
Type: filesandordirs; Name: "{app}"

[Run]
Filename: "{app}\DryCut.Desktop.exe"; Description: "Launch DryCut"; Flags: nowait postinstall skipifsilent
...
var
  ...
  FindData: TFindRec;
begin
  HistoryDirectory := ExpandConstant('{localappdata}\DryCut\history');
